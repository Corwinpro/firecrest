...
class OptimizationSolver(OptimizationMixin, UnsteadyTVAcousticSolver):
    ...
    def _objective_state(self, control):
        ...
        for state in self.solve_direct(
            initial_state, verbose=True, yield_state=True, plot_every=10
        ):
            if isinstance(state, TimeSeries):
                direct_history = state
                break

            with open("energy_fine_control_small_act.dat", "a") as file:
                _str = (
        ...
        exit()
        with open("log_simplified.dat", "a") as file:
            file.write(
                str(
...
fine_space_control = [
    0.0027218010274634792,
    0.0011022167473699743,
    0.0016208435033642488,
    0.0028414445611413307,
    0.0024598598409331543,
    0.002240275381978528,
    0.0035035928862498502,
    0.004436953277774263,
    0.003267646499825355,
    0.004726365757600708,
    0.0046932035533709185,
    0.003690471093652577,
    0.004987443084710113,
    0.005079150463948897,
    0.0044099129222678795,
    0.005095584575224682,
    0.005256166110337826,
    0.004439734081325669,
    0.0051124206099196585,
    0.005350013223676511,
    0.004544223406207635,
    0.005112449447270219,
    0.005141362849728469,
    0.004686299219817445,
    0.005320316752379594,
    0.005342225612395099,
    0.004989288379766195,
    0.005418854413888843,
    0.005302705198401764,
    0.005094519026801375,
    0.0056007752815766905,
    0.005397453467463256,
    0.0052200507240646185,
    0.0055954646640558,
    0.005335654596827413,
    0.005292443048160965,
    0.0057076715590944575,
    0.005326052619938249,
    0.005328156972172535,
    0.005574052844947187,
    0.005200376431750243,
    0.005391164477119684,
    0.005575896988254536,
    0.005086880973473718,
    0.005292338195397178,
    0.005407140111957345,
    0.00491320918175936,
    0.0052792168703684516,
    0.00531369438017898,
    0.004701263267092207,
    0.005066488770141772,
    0.005066901600374086,
    0.00451240306093277,
    0.005008181849834818,
    0.004848596884518937,
    0.004178907371003792,
    0.0047282180331134445,
    0.004565691114736264,
    0.004025429961403314,
    0.004687548894685344,
    0.004407918788265298,
    0.0037266186511809383,
    0.004457442977280911,
    0.0042314747877950625,
    0.003601580246040539,
    0.004238590720110128,
    0.003959940535317811,
    0.0030170947898442036,
    0.003892360957266297,
    0.003689523213496787,
    0.0027827804746762465,
    0.0035423423923735455,
    0.002758102946940804,
    0.001948056365082818,
    0.0022839636556756305,
    0.0025448166395637224,
    0.001602651403933199,
    0.0015851368366798315,
    0.0021762113341795026,
]
