...
from firecrest.solvers.tv_acoustic_solver import TVAcousticSolver
...
solver = TVAcousticSolver(domain, Re=1.0e3, Pe=10.0, dt=1.0e-2)
initial_state = (
    dolf.Expression(
...
for i in range(100):
    ...
    w = solver.solve(initial_state)  # , time_scheme="implicit_crank_nicolson")
